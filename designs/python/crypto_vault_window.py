...
class Ui_CryptoVault(object):
    def setupUi(self, CryptoVault):
        ...
        self.cmb_num_words.addItem("")
        self.cmb_num_words.addItem("")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.cmb_num_words)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.lbl_public)
        self.lbl_private = QtWidgets.QLabel(CryptoVault)
        self.lbl_private.setObjectName("lbl_private")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.lbl_private)
        self.lne_public = QtWidgets.QLineEdit(CryptoVault)
        self.lne_public.setObjectName("lne_public")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.lne_public)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.lbl_password_exp)
