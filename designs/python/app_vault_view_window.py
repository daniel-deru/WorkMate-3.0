...
class Ui_AppVaultViewDialog(object):
    def setupUi(self, AppVaultViewDialog):
        ...
        self.rbtn_name = QtWidgets.QRadioButton(AppVaultViewDialog)
        self.rbtn_name.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.rbtn_name.setStyleSheet("margin-right: 20px;")
        self.rbtn_name.setObjectName("rbtn_name")
        self.horizontalLayout.addWidget(self.rbtn_name)
        ...
        self.rbtn_username = QtWidgets.QRadioButton(AppVaultViewDialog)
        self.rbtn_username.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.rbtn_username.setStyleSheet("margin-right: 20px;")
        self.rbtn_username.setObjectName("rbtn_username")
        self.horizontalLayout_2.addWidget(self.rbtn_username)
        ...
        self.rbtn_email = QtWidgets.QRadioButton(AppVaultViewDialog)
        self.rbtn_email.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.rbtn_email.setStyleSheet("margin-right: 20px;")
        self.rbtn_email.setObjectName("rbtn_email")
        self.horizontalLayout_3.addWidget(self.rbtn_email)
        ...
        self.rbtn_password = QtWidgets.QRadioButton(AppVaultViewDialog)
        self.rbtn_password.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.rbtn_password.setStyleSheet("margin-right: 20px;")
        self.rbtn_password.setObjectName("rbtn_password")
        self.horizontalLayout_4.addWidget(self.rbtn_password)
        ...
        self.rbtn_path = QtWidgets.QRadioButton(AppVaultViewDialog)
        self.rbtn_path.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.rbtn_path.setStyleSheet("margin-right: 20px;")
        self.rbtn_path.setObjectName("rbtn_path")
        self.horizontalLayout_5.addWidget(self.rbtn_path)
    ...
    def retranslateUi(self, AppVaultViewDialog):
        ...
        self.rbtn_name.setText(_translate("AppVaultViewDialog", "Copy"))
        self.chk_name.setText(_translate("AppVaultViewDialog", "View"))
        ...
        self.rbtn_username.setText(_translate("AppVaultViewDialog", "Copy"))
        self.chk_username.setText(_translate("AppVaultViewDialog", "View"))
        self.label_3.setText(_translate("AppVaultViewDialog", "Email:"))
        self.lbl_email.setText(_translate("AppVaultViewDialog", "TextLabel"))
        self.rbtn_email.setText(_translate("AppVaultViewDialog", "Copy"))
        self.chk_email.setText(_translate("AppVaultViewDialog", "View"))
        ...
        self.rbtn_password.setText(_translate("AppVaultViewDialog", "Copy"))
        self.chk_password.setText(_translate("AppVaultViewDialog", "View"))
        self.label_5.setText(_translate("AppVaultViewDialog", "Path/URL:"))
        self.lbl_path.setText(_translate("AppVaultViewDialog", "TextLabel"))
        self.rbtn_path.setText(_translate("AppVaultViewDialog", "Copy"))
        self.chk_path.setText(_translate("AppVaultViewDialog", "View"))
