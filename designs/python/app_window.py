...
class Ui_App_Window(object):
    def setupUi(self, App_Window):
        ...
        self.hbox_protected_toggle = QtWidgets.QHBoxLayout()
        self.hbox_protected_toggle.setObjectName("hbox_protected_toggle")
        self.lbl_protected_app = QtWidgets.QLabel(App_Window)
        self.lbl_protected_app.setObjectName("lbl_protected_app")
        self.hbox_protected_toggle.addWidget(self.lbl_protected_app)
        self.chkbox_protected_app = QtWidgets.QCheckBox(App_Window)
        self.chkbox_protected_app.setText("")
        self.chkbox_protected_app.setObjectName("chkbox_protected_app")
        self.hbox_protected_toggle.addWidget(self.chkbox_protected_app)
        self.verticalLayout.addLayout(self.hbox_protected_toggle)
        self.vbox_protected_fields = QtWidgets.QVBoxLayout()
        self.vbox_protected_fields.setObjectName("vbox_protected_fields")
        self.verticalLayout.addLayout(self.vbox_protected_fields)
    ...
    def retranslateUi(self, App_Window):
        ...
        self.lbl_protected_app.setText(_translate("App_Window", "Protected App"))
