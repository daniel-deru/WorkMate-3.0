...
class Ui_Settings_tab(object):
    def setupUi(self, Settings_tab):
        ...
        self.chkbox_vault.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.btn_vault_timer.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.btn_export_apps.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.btn_export_notes.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.btn_import_apps.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.btn_import_notes.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.fcmbx_font.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.lbl_google_drive = QtWidgets.QLabel(Settings_tab)
        self.lbl_google_drive.setMinimumSize(QtCore.QSize(0, 50))
        self.lbl_google_drive.setObjectName("lbl_google_drive")
        self.horizontalLayout_8.addWidget(self.lbl_google_drive)
        self.chk_google_drive = QtWidgets.QCheckBox(Settings_tab)
        self.chk_google_drive.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.chk_google_drive.setText("")
        self.chk_google_drive.setObjectName("chk_google_drive")
        self.horizontalLayout_8.addWidget(self.chk_google_drive)
        ...
        self.horizontalLayout_9.addWidget(self.btn_google_drive_sync)
    ...
    def retranslateUi(self, Settings_tab):
        ...
        self.lbl_google_drive.setText(_translate("Settings_tab", "Add Remote Backup to Google Drive"))
        self.btn_google_drive_sync.setText(_translate("Settings_tab", "Sync From Google Drive"))
