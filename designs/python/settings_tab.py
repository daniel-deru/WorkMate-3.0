...
class Ui_Settings_tab(object):
    def setupUi(self, Settings_tab):
        ...
        self.chkbx_night_mode = QtWidgets.QCheckBox(Settings_tab)
        self.chkbx_night_mode.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.chkbx_night_mode.setAutoFillBackground(True)
        self.chkbx_night_mode.setText("")
        self.chkbx_night_mode.setObjectName("chkbx_night_mode")
        self.hbox_night_mode.addWidget(self.chkbx_night_mode)
