...
class Ui_Vault_tab(object):
    def setupUi(self, Vault_tab):
        ...
        self.cmb_groups = QtWidgets.QComboBox(Vault_tab)
        self.cmb_groups.setObjectName("cmb_groups")
        self.hbox_controls.addWidget(self.cmb_groups)
        self.btn_groups = QtWidgets.QPushButton(Vault_tab)
        self.btn_groups.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btn_groups.setObjectName("btn_groups")
        self.hbox_controls.addWidget(self.btn_groups)
    ...
    def retranslateUi(self, Vault_tab):
        ...
        self.btn_groups.setText(_translate("Vault_tab", "Manage Groups"))
